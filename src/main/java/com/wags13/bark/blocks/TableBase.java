...
public class TableBase extends BlockBase {
    ...
    public TableBase(String type) {
        super(type + "_table", Material.WOOD);
        setHardness(1F);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        boolean blockNorth = blockTemp instanceof TableBase;
        stateTemp = worldIn.getBlockState(pos.south());
        blockTemp = stateTemp.getBlock();
        boolean blockSouth = blockTemp instanceof TableBase;
        stateTemp = worldIn.getBlockState(pos.east());
        blockTemp = stateTemp.getBlock();
        boolean blockEast = blockTemp instanceof TableBase;
        stateTemp = worldIn.getBlockState(pos.west());
        blockTemp = stateTemp.getBlock();
        boolean blockWest = blockTemp instanceof TableBase;

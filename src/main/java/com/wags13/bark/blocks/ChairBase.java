...
public class ChairBase extends BlockBase {
  ...
  public ChairBase(String type) {
      super(type + "_chair", Material.WOOD);
      setHardness(1F);
  ...
  public static class Chair extends Entity {
      ...
      public void onUpdate() {
          ...
          if (pos != null && !(getEntityWorld().getBlockState(pos).getBlock() instanceof ChairBase)) {
              setDead();
              return;
          }
